<?php
	...
	function test_slashes_to_directory_separator_()
	{
	...
	function test_str_underscorize_()
	{
		should_return('A_e_I_o_U_9_', when_passed('A!e@I#o%U&9-'));
	}


	function test_str_sanitize_()
	{
	...
	function test_array_keys_exists_()
	{
